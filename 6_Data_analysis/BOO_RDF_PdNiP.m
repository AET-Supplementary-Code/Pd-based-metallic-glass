...
model = importdata('./Input/Final_atomic_model_PdNiP.mat');
atoms = importdata('./Input/Final_atomtype_PdNiP.mat');
...
%%
%save data
save('./OutPut/BOO_RDF_PdNiP.mat','radius_arr','rdf_arr','pdf_arr','volume_arr','scaled_SROP','boo_Q4_full','boo_Q6_full');